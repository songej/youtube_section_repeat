(function() {
  ...
  // [ADDED] Define internal task types as constants to prevent typos and improve maintainability.
  const INTERNAL_TASK_TYPES = Object.freeze({
    CONTENT_SCRIPT_INIT_STARTED: 'CONTENT_SCRIPT_INIT_STARTED',
    CONTENT_SCRIPT_READY: 'CONTENT_SCRIPT_READY',
    REPEAT_STATE_CHANGED: 'REPEAT_STATE_CHANGED',
    ...
    SET_FOCUS_MODE: 'SET_FOCUS_MODE',
    RECONCILE_TAB_STATES: 'RECONCILE_TAB_STATES',
    CLEAR_STATE_IF_NOT_VIDEO_PAGE: 'CLEAR_STATE_IF_NOT_VIDEO_PAGE',
  });
